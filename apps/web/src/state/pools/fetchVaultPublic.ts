...
const cakeVaultV2 = getCakeVaultAddress(ChainId.SHIB_TESTNET)

const cakeFlexibleSideVaultV2 = getCakeFlexibleSideVaultAddress(ChainId.SHIB_TESTNET)
...
export const fetchPublicVaultData = async (cakeVaultAddress = cakeVaultV2) => {
  try {
    ...
    const cakeBalanceOfCall = {
      abi: cakeAbi,
      address: CAKE[ChainId.SHIB_TESTNET].address,
      name: 'balanceOf',
      params: [cakeVaultV2],
    }
