  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/app.ball.exchange',
      qrCode,
      downloadLink: 'https://metamask.app.link/app.ball.exchange',
    },
    {
      id: 'binance',
    ...
    },
    {
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://ball.exchange/',
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.ball.exchange/get-started/get-started`
    : `https://docs.ball.exchange/get-started/get-started`
