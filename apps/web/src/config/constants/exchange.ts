...
import { bscTokens, bscTestnetTokens, USDC, USDT, BUSD, WBTC_ETH, shibTestnetTokens } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.SHIB_TESTNET]: '0xeEa40EF89414073ED71425018964E359Cb6bEE03'
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.SHIB_TESTNET]: [shibTestnetTokens.wbone, shibTestnetTokens.usdc, shibTestnetTokens.usdt]
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.SHIB_TESTNET]: [shibTestnetTokens.cake,shibTestnetTokens.wbone, shibTestnetTokens.usdc, shibTestnetTokens.usdt]
}
...
export const LIMIT_ORDERS_DOCS_URL = 'https://docs.ball.exchange/products/pancakeswap-exchange/limit-orders'
