  ...
  return (
    <Container expanded={expanded}>
      <InfoContainer>
        ...
        {isActive && (
          <Flex mb="7px" justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
            <StakeContainer>
        ...
        <Flex mb="7px" justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
          <StyledLinkExternal target='_blank' href="https://docs.ball.exchange/products-and-fearures/farm/how-to-farm">{t('How To Farm?')}</StyledLinkExternal>
        </Flex>
      </InfoContainer>
      <ActionContainer>
        {shouldUseProxyFarm ? (
