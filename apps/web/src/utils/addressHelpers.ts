...
export const getICakeAddress = () => {
  return getAddress(addresses.iCake, ChainId.SHIB_TESTNET)
}

export const getBCakeFarmBoosterAddress = () => {
  return getAddress(addresses.bCakeFarmBooster, ChainId.SHIB_TESTNET)
}

export const getBCakeFarmBoosterProxyFactoryAddress = () => {
  return getAddress(addresses.bCakeFarmBoosterProxyFactory, ChainId.SHIB_TESTNET)
}
