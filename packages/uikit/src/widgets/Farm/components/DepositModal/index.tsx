...
//console.log( interestBreakdown,!lpTokensToStake.isNaN() ? usdToStake.toNumber() : 0,apr,cakePrice.toNumber())
  ...
  //console.log(!lpTokensToStake.isNaN() ? usdToStake.toNumber() : 0, cakePrice.toNumber(),annualRoi,formattedAnnualRoi)
