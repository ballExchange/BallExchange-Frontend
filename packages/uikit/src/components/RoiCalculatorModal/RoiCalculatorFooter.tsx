    ...
    <>
      {rewardCakePerSecond ? (
        <>
          <Text>
            {t(
              "The Multiplier represents the proportion of BALL rewards each farm receives, as a proportion of the BALL produced each second."
            )}
          </Text>
          <Text my="24px">
            {" "}
            {t("For example, if a 1x farm received 1 BALL per second, a 40x farm would receive 40 BALL per second.")}
          </Text>
        ...
        <>
          <Text>
            {t(
              "The Multiplier represents the proportion of BALL rewards each farm receives, as a proportion of the BALL produced each block."
            )}
          </Text>
          <Text my="24px">
            {" "}
            {t("For example, if a 1x farm received 1 BALL per block, a 40x farm would receive 40 BALL per block.")}
          </Text>
          <Text>
            {t(
              "We have recently rebased multipliers by a factor of 10, this is only a visual change and does not affect the amount of BALL each farm receives."
            )}
          </Text>
        </>
      )}
